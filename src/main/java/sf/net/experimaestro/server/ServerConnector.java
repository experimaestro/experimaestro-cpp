 ...
 * ConnectionFactories, whose generic use is described in {@link org.eclipse.jetty.server.AbstractConnector}.
 ...
 * instance is passed, then this used to instantiate a {@link org.eclipse.jetty.server.SslConnectionFactory} which is
...
public class ServerConnector extends AbstractNetworkConnector
{
    ...
    volatile ServerSocketChannel _acceptChannel;
