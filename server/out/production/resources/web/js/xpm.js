...
var Resource = (function () {
    function Resource(r) {
        ...
        this.node = $e("li")
            ...
            .append($("<i class=\"fa fa-trash-o link\" title='Delete resource' name='delete'></i>")))).append($e("div")
    ...
    Resource.prototype.progress = function (r) {
        if (!r.progress)
            return;
    ...
    Resource.prototype.set_state = function (_state) {
        var state = (_state.toLowerCase());
...
var Experiment = (function () {
    function Experiment(name, timestamp) {
        this.name = name;
...
var XPM = (function () {
    function XPM() {
        this.task2resource = {};
        this.taskname2id = {};
        this.filtered_tasks = new Set();
        // List of resources
        this.resources = {};
    }
    XPM.prototype.start_websocket = function () {
    ...
    XPM.prototype.request = function (name, params) {
        this.server.call(name, params.params, params.success, params.error);
    };
    XPM.prototype.handle_ws_open = function () {
        ...
        this.server.call("listen", {}, function () {
        }, jsonrpc_error);
        // Load experiments
    ...
    ;
    /** Get the experiments */
    XPM.prototype.get_experiments = function () {
        var selection = sessionStorage.getItem("experiment.selection");
        var _this = this;
        this.server.call('experiments.latest-names', {}, function (r) {
     ...
     * @param timestamp
     */
    XPM.prototype.load_experiment = function (timestamp) {
        ...
        this.server.call('experiments.resources', { identifier: experiment, timestamp: timestamp }, function (r) {
            var tasks = r.tasks;
            var available_tasks = [];
            var set = new Set();
            for (var _tid in tasks) {
                var tid = Number.parseInt(_tid);
            ...
            function change_state(taskname, display) {
                ...
                for (var i = 0; i < taskids.length; ++i) {
                    ...
                    if (display)
                        _this.filtered_tasks.add(taskids[i]);
                    else
                        _this.filtered_tasks.delete(taskids[i]);
            ...
            tasks_chooser.tagit({
                ...
                afterTagAdded: function (event, ui) {
                    ...
                    if (tag_count == 0)
                        $("#resources").children().addClass("notintask");
                    ++tag_count;
                    // And then filter
    ...
    XPM.prototype.handle_message = function (resp) {
    ...
    XPM.prototype.get_resource = function (id) {
    ...
    XPM.prototype.add_resource = function (r) {
    ...
    XPM.prototype.find_resource = function (element) {
        var e = $(element);
        while (!e.is("html")) {
    ...
    /// Click on a link
    XPM.prototype.resource_link_callback = function (event) {
        var resource = this.find_resource(event.target);
        this.server.call('getResourceInformation', { id: resource.id }, function (r) {
    ...
    XPM.prototype.resource_action_callback = function (event) {
    ...
    ;
    XPM.prototype.show_xpm_info = function () {
        var e = $("#xpm-info");
        if (this.xpm_info_loaded)
            return true;
        this.server.call('buildInformation', {}, function (r) {
            this.xpm_info_loaded = true;
            e.append($e("h2")
                .append($t("Build information")))
                .append($e("dl").append($e("dt").append($t("Branch")), $e("dd").append(r.result.branch), $e("dt").append($t("Commit hash")), $e("dd").append(r.result.commitID), $e("dt").append($t("Dirty")), $e("dd").append(r.result.dirty ? "True" : "False"), $e("dt").append($t("Commit ID")), $e("dd").append(r.result.commitID), $e("dt").append($t("Tags")), $e("dd").append(r.result.tags)));
        }, jsonrpc_error);
    };
    return XPM;
}());
$().ready(function () {
    ...
    function listFilter(list) {
        ...
        var form = $("<form>").attr({ "class": "filterform", "action": "javascript:void(0)" }), input = $("<input>").attr({ "class": "filterinput", "type": "text" });
    ...
    function show_class_documentation() {
        ...
        xpm.server.call("documentation.methods", { classname: classname }, function (r) {
    ...
    function showexperiments(element) {
        ...
        d3.xhr("/json-rpc")
            ...
            .post(JSON.stringify(rpcData), function (error, data) {
            if (error)
                throw error;
    ...
    $(".tab").tabs({
        beforeActivate: function (event, ui) {
            ...
            if (tabid == "experiments") {
                ...
                xpm.server.call("documentation.classes", {}, function (r) {
                    $.each(r, function (ix, e) {
